...
export type ResearchGroup = Schemas['ResearchGroup'];
export type StaleOverview = Schemas['StaleOverview'];
export type TaxonomyReport = Schemas['TaxonomyReport'];
export type TaxonomyView = Schemas['TaxonomyView'];
export type TaxonomyTermView = Schemas['TaxonomyTermView'];
export type SynthesisReport = Schemas['SynthesisReport'];
export type MatrixView = Schemas['MatrixView'];
export type MatrixRowView = Schemas['MatrixRowView'];
export type MatrixColumnView = Schemas['MatrixColumnView'];
export type MatrixCellView = Schemas['MatrixCellView'];
export type MatrixEvidenceView = Schemas['MatrixEvidenceView'];
